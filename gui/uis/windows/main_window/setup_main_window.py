...
class SetupMainWindow:
    ...
    def setup_gui(self):
        ...
        if self.settings["custom_title_bar"]:
            ...
            self.ui.title_bar.set_title("Welcome to Fancy Shop")
        ...
        self.apply_icon(self.theme_button)
        self.ui.left_column.menus.btn_3_layout.addWidget(self.theme_button)
        ...
        # ADD TOGGLE BUTTON TO PY ONE DARK
